...
3. Dentro del proyecto en TestApi\Properties\launchSettings.json la cadena de conexion de su base de datos en el perfil que vaya a usar de preferencia en TestApi
en la variable que se llama "DBString" si ejecuto el scrip solo sera necesario cambiar el nombre del server.
